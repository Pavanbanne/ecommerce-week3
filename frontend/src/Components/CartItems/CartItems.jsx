...
const CartItems = () => {
  ...
  const handlePromoCode = () => {
    ...
    if (promoCode === 'ABOVE3000' && totalAmount > 3000) {
      setDiscount(500 / totalAmount); // Flat ₹500 discount
    } else {
      setDiscount(0); // No discount
      alert('Invalid promo code or conditions not met'); // Alert for invalid promo code
    }
  };
